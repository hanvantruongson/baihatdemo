...
<head>
    ...
    <!-- FONTAWESOME STYLES-->
    <link href="<%=GlobalConstant.URL_ADMIN%>/assets/css/font-awesome.css" rel="stylesheet" />
    <!-- CUSTOM STYLES-->
    <link href="<%=GlobalConstant.URL_ADMIN%>/assets/css/custom.css" rel="stylesheet" />
    <!-- GOOGLE FONTS-->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    <script type="text/javascript" src="<%=GlobalConstant.URL_ADMIN %>/ckeditor/ckeditor.js"></script>
    <!-- JQUERY -->
	<script src="<%=GlobalConstant.URL_ADMIN%>/assets/js/jquery-3.2.1.js"></script>
	<script src="<%=GlobalConstant.URL_ADMIN%>/assets/js/jquery.validate.min.js"></script>
</head>
